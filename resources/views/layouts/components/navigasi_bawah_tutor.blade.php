<nav class="bottomNavAdmin">
    <a href="{{ route('tutor.dashboard') }}"
       class="{{ request()->routeIs('tutor.dashboard') ? 'active' : '' }}"
    ...
    <a href="{{ route('tutor.presensi') }}"
       class="{{ request()->routeIs('tutor.presensi*') ? 'active' : '' }}"
       aria-label="Absen">
    ...
    <a href="{{ route('tutor.riwayat') }}"
       class="{{ request()->routeIs('tutor.riwayat*') ? 'active' : '' }}"
       aria-label="Riwayat">
        <ion-icon name="{{ request()->routeIs('tutor.riwayat*') ? 'time' : 'time-outline' }}"></ion-icon>
        <span>Riwayat</span>
    </a>

    <a href="{{ route('tutor.pengajuan-izin') }}"
       class="{{ request()->routeIs('tutor.pengajuan-izin*') ? 'active' : '' }}"
    ...
    <a href="{{ route('tutor.jadwal') }}"
       class="{{ request()->routeIs('tutor.jadwal*') ? 'active' : '' }}"
       aria-label="Agenda">
        <ion-icon name="{{ request()->routeIs('tutor.jadwal*') ? 'calendar' : 'calendar-outline' }}"></ion-icon>
        <span>Agenda</span>
    </a>

    <a href="{{ route('tutor.payroll.index') }}"
       class="{{ request()->routeIs('tutor.payroll*') ? 'active' : '' }}"
       aria-label="Payroll">
