        ...
        @if ($activeSesi)
            ...
            @else
                <div class="card text-center p-4 rounded-xl">
                    ...
                    <div class="text-sm text-muted mt-1">Tersisa {{ number_format($sisaDetik / 60, 0) }} menit lagi (minimal 1 jam durasi magang)</div>
                </div>
            @endif
            ...
            @if ($todayPresensi && $todayPresensi->jam_selesai)
                <div class="statusBanner ready mb-3 bg-success-light">
                    <div>
                        ...
                        <div class="statusSub">Anda sudah presensi masuk ({{ substr((string)$todayPresensi->jam_mulai,0,5) }}) dan pulang ({{ substr((string)$todayPresensi->jam_selesai,0,5) }}).</div>
                    </div>
                </div>
            @else
                @if(isset($shiftEval))
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="mb-3" id="boxPilihLokasi">
                            <label class="d-block text-sm font-semibold text-muted mb-2">
                                Pilih Lokasi Magang / Mitra <span class="text-danger">*</span>
                            </label>
