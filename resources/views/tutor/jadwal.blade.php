...
<div class="agendaPage">
    ...
    <div class="agendaHeaderCard">
        ...
        <div class="agendaMonthNav">
            <a href="{{ route('tutor.jadwal', ['tanggal' => $prevMonthDate]) }}" class="agendaNavBtn" title="Bulan Sebelumnya">
            ...
            <a href="{{ route('tutor.jadwal', ['tanggal' => $nextMonthDate]) }}" class="agendaNavBtn" title="Bulan Berikutnya">
