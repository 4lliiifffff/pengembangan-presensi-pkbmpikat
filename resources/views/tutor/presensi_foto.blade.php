                ...
                <div class="card mb-4">
                    ...
                    <div class="pos-relative" id="wrapperSiswaDropdown">
                        ...
                        <div class="border-base rounded-lg p-2 bg-card-alt">
                            ...
                            <div id="listSiswaItems" class="overflow-y-auto max-h-180 pr-1">
    ...
    <script >
        ...
        function setMapFromLatLng(lat, lng) {
            ...
            if (leafletMap) {
                ...
                // Track Line Polyline (Garis Rute Panduan ke PKBM)
                if (trackPolyline) {
                ...
                if (radarCard && radarDot && radarTitle && radarSub) {
                    ...
                    if (isWithin) {
                        ...
                        if (dist > 200) {
                            ...
                            radarTitle.textContent = '🚶‍♂️ Mendekati Sekolah (' + distFormatted + ' m — Tinggal ' + sisaJarak + ' m lagi)';
                            radarSub.textContent = 'Sedikit lagi! Bergeraklah mendekati area sekolah agar tombol presensi aktif.';
                        }
                        ...
                        radarDot.className = 'radarStatusDot pulse-green';
                        radarTitle.textContent = '📍 Moda Kunjungan / Online Aktif (' + distFormatted + ' m dari sekolah)';
