            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-5 flex flex-col gap-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lokasi" value="{{ old('nama_lokasi') }}" placeholder="Contoh: Gedung Pusat PKBM Pikat, Cabang Bantul..." class="form-control w-full" required>
                        <small class="text-xs text-muted">Nama ini akan muncul pada pilihan presensi tutor dan magang.</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipe" class="form-control w-full" required>
                            ...
                            <option value="cabang" {{ old('tipe') == 'cabang' ? 'selected' : '' }}>🏫 Cabang / Rombel Belajar</option>
                            <option value="mitra" {{ old('tipe') == 'mitra' ? 'selected' : '' }}>🤝 Instansi Mitra PKL / Magang</option>
                            <option value="kegiatan" {{ old('tipe') == 'kegiatan' ? 'selected' : '' }}>🎪 Sentra Belajar / Acara Khusus</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" rows="2" placeholder="Jl. Raya No..., Kelurahan, Kecamatan..." class="form-control w-full">{{ old('alamat') }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="latitude" id="inputLat" value="{{ old('latitude', $defaultLat) }}" class="form-control w-full font-mono text-sm" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label font-bold text-dark text-sm mb-1 d-block">Longitude <span class="text-danger">*</span></label>
                            <input type="number" step="any" name="longitude" id="inputLng" value="{{ old('longitude', $defaultLng) }}" class="form-control w-full font-mono text-sm" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-between items-center mb-1">
                            ...
                            <span class="badgeDate text-xs px-2 py-0.5 font-bold" id="radiusBadgeVal">{{ old('radius_meter', $defaultRadius) }} Meter</span>
                        </div>
                        <input type="range" min="10" max="1000" step="5" id="sliderRadius" value="{{ old('radius_meter', $defaultRadius) }}" class="w-full h-2 bg-slate-200 rounded-lg cursor-pointer">
                        <div class="d-flex items-center gap-2 mt-2">
                            <input type="number" min="10" max="5000" name="radius_meter" id="inputRadius" value="{{ old('radius_meter', $defaultRadius) }}" class="form-control w-28 text-center font-bold" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" value="{{ old('keterangan') }}" placeholder="Catatan tambahan lokasi..." class="form-control w-full">
                    </div>

                    <div class="form-check mt-2">
                        <label class="d-flex items-center gap-2 cursor-pointer font-semibold text-dark text-sm">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', '1') == '1' ? 'checked' : '' }} class="rounded border-slate-300 text-primary focus:ring-primary h-4 w-4">
                            Aktifkan titik lokasi ini untuk presensi
                        </label>
                    </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 d-flex gap-2">
                        <button type="submit" class="profileBtnPrimary flex-1 justify-center py-2.5">
                            <ion-icon name="save-outline"></ion-icon> Simpan Titik Lokasi
                        </button>
