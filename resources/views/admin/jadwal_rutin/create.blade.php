        ...
        <form action="{{ route('admin.jadwal-rutin.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem; margin-bottom: 1.25rem;">
                <div>
                    ...
                    <input type="time" name="jam_masuk" id="jam_masuk" value="{{ old('jam_masuk', '09:00') }}" required class="filterInput" style="width: 100%;">
                </div>
                ...
                <div>
                    ...
                    <input type="time" name="jam_pulang" id="jam_pulang" value="{{ old('jam_pulang', '11:00') }}" required class="filterInput" style="width: 100%;">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.25" min="0.5" max="24" name="durasi_jam" id="durasi_jam" value="{{ old('durasi_jam', '2.00') }}" class="filterInput" style="width: 100%;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem; margin-bottom: 1.25rem;">
                <div>
                    ...
                    <input type="date" name="berlaku_mulai" value="{{ old('berlaku_mulai', date('Y-m-d')) }}" class="filterInput" style="width: 100%;">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="berlaku_sampai" value="{{ old('berlaku_sampai') }}" class="filterInput" style="width: 100%;">
                </div>
            </div>
            ...
            <div style="margin-bottom: 1.25rem;">
                ...
                <textarea name="keterangan" rows="2" placeholder="Catatan khusus kesepakatan belajar..." class="filterInput" style="width: 100%; height: auto;">{{ old('keterangan') }}</textarea>
            </div>
            ...
            <div style="margin-bottom: 1.25rem; display: flex; flex-direction: column; gap: 8px;">
                ...
                <div style="display: flex; align-items: center; gap: 8px;">
                    <input type="checkbox" id="auto_generate" name="auto_generate" value="1" {{ old('auto_generate', true) ? 'checked' : '' }} style="width: 16px; height: 16px;">
                    <label for="auto_generate" style="font-size: 0.85rem; color: #047857; font-weight: 600; cursor: pointer;">
                        ⚡ Langsung generate sesi kalender KBM untuk 4 minggu ke depan
                    </label>
                </div>
            </div>
