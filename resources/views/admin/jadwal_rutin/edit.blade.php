        ...
        <form action="{{ route('admin.jadwal-rutin.update', $jadwalRutin) }}" method="POST">
            ...
            <div class="form-grid-responsive mb-4">
                <div class="form-field-wrapper">
                    ...
                    <input type="time" name="jam_masuk" id="jam_masuk" value="{{ old('jam_masuk', substr((string) $jadwalRutin->jam_masuk, 0, 5)) }}" required class="profileInput">
                </div>
                ...
                <div class="form-field-wrapper">
                    ...
                    <input type="time" name="jam_pulang" id="jam_pulang" value="{{ old('jam_pulang', substr((string) $jadwalRutin->jam_pulang, 0, 5)) }}" required class="profileInput">
                </div>
                ...
                <div class="form-field-wrapper">
                    ...
                    <input type="number" step="0.25" min="0.5" max="24" name="durasi_jam" id="durasi_jam" value="{{ old('durasi_jam', $jadwalRutin->durasi_jam) }}" class="profileInput">
                </div>
            </div>
            ...
            <div class="form-grid-responsive mb-4">
                <div class="form-field-wrapper">
                    ...
                    <input type="date" name="berlaku_mulai" value="{{ old('berlaku_mulai', $jadwalRutin->berlaku_mulai?->format('Y-m-d')) }}" class="profileInput">
                </div>
                ...
                <div class="form-field-wrapper">
                    ...
                    <input type="date" name="berlaku_sampai" value="{{ old('berlaku_sampai', $jadwalRutin->berlaku_sampai?->format('Y-m-d')) }}" class="profileInput">
                </div>
            </div>
            ...
            <div class="form-field-wrapper mb-4">
                ...
                <textarea name="keterangan" rows="2" placeholder="Catatan khusus kesepakatan belajar..." class="profileInput" style="height: auto; resize: vertical;">{{ old('keterangan', $jadwalRutin->keterangan) }}</textarea>
            </div>

            <div class="form-grid-responsive mb-4">
                <div class="checkbox-toggle-card">
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $jadwalRutin->is_active) ? 'checked' : '' }}>
                ...
                <div class="checkbox-toggle-card">
                    <input type="checkbox" id="sync_future" name="sync_future" value="1" {{ old('sync_future', true) ? 'checked' : '' }}>
                    <label for="sync_future" class="cursor-pointer text-success" style="margin: 0;">
